...
int nand_scan_tail(struct mtd_info *mtd)
{
	 ...
	 */
	printk("NAND_ECC_HW_OOB_FIRST:%d\n",NAND_ECC_HW_OOB_FIRST);
	printk("NAND_ECC_HW:%d\n",NAND_ECC_HW);
	printk("NAND_ECC_HW_SYNDROME:%d\n",NAND_ECC_HW_SYNDROME);
	printk("NAND_ECC_SOFT:%d\n",NAND_ECC_SOFT);
	printk("NAND_ECC_SOFT_BCH:%d\n",NAND_ECC_SOFT_BCH);
	printk("NAND_ECC_NONE:%d\n",NAND_ECC_NONE);
	printk("chip->ecc.mode:%d\n",chip->ecc.mode);
